function userObj() {
   ...
   */
  this.construct = function(user_id, name, surname, nickname, location, email, birthday, password, privileges, newsletter, avatar_path) {
  ...
  this.toString = function() {
    ...
    userString += " birthday=" + this.getBirthday() + " privileges=" + this.getPrivileges() + " newsletter=" + this.getNewsletter() + " avatar path=" + this.getAvatarPath();
